...
sudo yum install https://github.com/shigechika/nginx-module-pagespeed/releases/download/1.25.1/nginx-module-pagespeed-1.25.1-1.el7.ngx.x86_64.rpm
```
...
rpm -Uvh https://nginx.org/packages/mainline/centos/7/SRPMS/nginx-1.25.1-1.el7.ngx.src.rpm
...
sudo yum localinstall ~/rpmbuild/RPMS/x86_64/nginx-module-pagespeed-1.25.1-1.el7.ngx.x86_64.rpm
```
